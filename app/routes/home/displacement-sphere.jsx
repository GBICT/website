...
export const DisplacementSphere = props => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // WebGL can be unavailable (context limit, disabled/blocked GPU, etc.).
      // Skip the decorative background sphere instead of crashing the page.
      console.warn('Displacement sphere disabled: WebGL unavailable.', error);
